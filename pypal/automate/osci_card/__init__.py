...
An Alazar command library is required, and must be obtained from Alazar Tech when the card is purchased. The library should be saved as 
AlazarCmd.py in the osci_card folder to be imported by the controller module.
