...
Program will prompt for confirmation that user wishes to control the laser with PLACE.  Then, the laser will turn on and the user will be prompted for confirmation to turn the laser on REP.  The laser power will initially be set to 0 percent.  Then the user can type a value between 0 and 100 to choose the percent power of the laser to fire at or choose 'stop' to turn the laser off.
-----------------------------------------------------------------
***************** W A R N I N G *********************************
-----------------------------------------------------------------
As soon as a numerical value between 0 and 100 is chosen the laser will fire!  
MAKE SURE that the energy meter, beam dump, or sample is in the path and you are fully aware of the path of the beam.
-----------------------------------------------------------------
**NOTE: the master power on the laser must be 'on', the key turned, and the 'computer' switch selected on the power supply of the laser in order for this program to work.
