...
var _user$project$Counter$toJson = function (counter) {
...
var _user$project$Counter$sendJson = function (counter) {
	return {
		ctor: '_Tuple2',
		_0: counter,
		_1: _user$project$Counter$jsonData(
...
var _user$project$Counter$changeSleep = F2(
	function (newValue, counter) {
		return A2(
			_user$project$Counter$update,
			_user$project$Counter$SendJson,
...
var _user$project$Counter$plotView = function (counter) {
	return {
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onInput(_user$project$Counter$PlotSwitch),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Counter$ChangeSleep = function (a) {
	return {ctor: 'ChangeSleep', _0: a};
};
var _user$project$Counter$sleepView = function (counter) {
	return {
		ctor: '::',
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onInput(_user$project$Counter$ChangeSleep),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _user$project$Counter$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$Counter$priorityView = function (counter) {
	return {
		ctor: '::',
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Counter$ChangePriority),
							_1: {ctor: '[]'}
						}
					}
				},
	...
	return _elm_lang$core$Native_Utils.eq(counter.name, 'None') ? {
		...
		_1: {
			...
			_0: A2(
				...
				{ctor: '[]'},
				_user$project$Counter$counterNameView(counter)),
			_1: {ctor: '[]'}
		}
	} : {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$p,
					{ctor: '[]'},
					_user$project$Counter$priorityView(counter)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$p,
						{ctor: '[]'},
						_user$project$Counter$sleepView(counter)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$p,
							{ctor: '[]'},
							_user$project$Counter$plotView(counter)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _user$project$Counter$view = function (counter) {
	return A2(
		...
		{ctor: '[]'},
		_user$project$Counter$mainView(counter));
};
