...
var _user$project$CustomScript1$viewModel = function (model) {
	return A2(
		...
		A4(_user$project$ModuleHelpers$title, _user$project$CustomScript1$placeModuleTitle, model.active, _user$project$CustomScript1$ToggleActive, _user$project$CustomScript1$Close),
		model.active ? {
			ctor: '::',
