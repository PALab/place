	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
				case 'ToggleActive':
					if (model.active) {
						var _v1 = _user$project$Tektronix$SendJson,
						...
						var _v3 = _user$project$Tektronix$SendJson,
							_v4 = _elm_lang$core$Native_Utils.update(
							model,
							{className: 'DPO3014', active: true});
						msg = _v3;
						model = _v4;
						continue updateModel;
					}
				case 'TogglePlot':
					var _v5 = _user$project$Tektronix$SendJson,
					...
					continue updateModel;
				case 'ToggleTrigger':
					var _v7 = _user$project$Tektronix$SendJson,
					...
					continue updateModel;
				case 'ChangePriority':
					var _v9 = _user$project$Tektronix$SendJson,
...
var Elm = {};
Elm['Tektronix'] = Elm['Tektronix'] || {};
if (typeof _user$project$Tektronix$main !== 'undefined') {
    _user$project$Tektronix$main(Elm['Tektronix'], 'Tektronix', undefined);
}
