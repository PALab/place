...
var _user$project$IQDemodulation$defaultModel = {moduleName: 'iq_demod', className: 'None', active: false, priority: 1000, plot: true, fieldEnding: 'trace', removeData: false, lowpassCutoff: '10e6', yShift: '-8192'};
...
var _user$project$IQDemodulation$viewModel = function (model) {
	return A2(
		...
		A4(_user$project$ModuleHelpers$title, 'IQ demodulation', model.active, _user$project$IQDemodulation$ToggleActive, _user$project$IQDemodulation$Close),
		model.active ? {
			ctor: '::',
