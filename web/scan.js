...
var _user$project$Scan$updateInstruments = F2(
	function (newData, oldData) {
		...
		if (_p0.ctor === 'Nothing') {
			...
			return _elm_lang$core$Native_Utils.eq(_p1.class_name, 'None') ? A2(
				...
				_user$project$Scan$notModule(_p1.module_name),
				oldData) : A2(
...
var _user$project$Scan$encodeScan = F2(
			...
			_elm_lang$core$Json_Encode$object(
				{
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'scan_type',
						_1: _elm_lang$core$Json_Encode$string(scan.scan_type)
					},
					_1: {
						ctor: '::',
						_0: {
...
var _user$project$Scan$socket = 'ws://localhost:9130';
				...
				if (_p3.ctor === 'Err') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							scan,
							{
								instruments: A2(_user$project$Scan$updateInstruments, _p3._0, scan.instruments)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Scan$view = function (scan) {
	return A2(
...
var _user$project$Scan$main = _elm_lang$html$Html$program(
	{
		...
		view: _user$project$Scan$view,
		update: _user$project$Scan$update,
		subscriptions: _user$project$Scan$subscriptions
	})();
