...
var _PALab$place$Helpers$onload = function (script) {
	return A2(
		_elm_lang$html$Html_Attributes$property,
		'onload',
		_elm_lang$core$Json_Encode$string(script));
};
var _PALab$place$Helpers$anOption = F3(
	function (currentValue, optionValue, displayValue) {
		return A2(
			_elm_lang$html$Html$option,
			{
				...
				_1: {
					...
					_0: _elm_lang$html$Html_Attributes$selected(
						_elm_lang$core$Native_Utils.eq(currentValue, optionValue)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _PALab$place$Place$makeJsonExperiment = function (experiment) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _PALab$place$Place$PostResponse = function (a) {
...
var _PALab$place$Place$update = F2(
	function (msg, experiment) {
		...
		switch (_p4.ctor) {
			...
			case 'UpdateModules':
				var _p5 = _PALab$place$Place$decoder(_p4._0);
				if (_p5.ctor === 'Err') {
					var newState = _PALab$place$Place$experimentErrorState(_p5._0);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							newState,
					...
					return {
						ctor: '_Tuple2',
						_0: A2(_PALab$place$Place$updateModules, _p5._0, experiment),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'PostResponse':
