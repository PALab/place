...
var _user$project$ATS9462Config$options = {
...
var _user$project$ATS9462Config$defaultAnalogInput = {input_channel: 'CHANNEL_A', input_coupling: 'DC_COUPLING', input_range: '2v-50ohm'};
var _user$project$ATS9462Config$defaultConfig = {
	clock_source: 'INTERNAL_CLOCK',
	sample_rate: 'SAMPLE_RATE_10MSPS',
	clock_edge: 'CLOCK_EDGE_RISING',
	decimation: '0',
	analog_inputs: _elm_lang$core$List$singleton(_user$project$ATS9462Config$defaultAnalogInput),
...
var _user$project$ATS9462Config$default = function (metadata) {
	return {active: false, priority: metadata.defaultPriority, metadata: metadata, config: _user$project$ATS9462Config$defaultConfig, progress: _elm_lang$core$Json_Encode$null};
};

var _user$project$ATS9462$toJson = F2(
...
var _user$project$ATS9462$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$ATS9462$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
var _user$project$ATS9462$processProgress = _elm_lang$core$Native_Platform.incomingPort('processProgress', _elm_lang$core$Json_Decode$value);
var _user$project$ATS9462$Close = {ctor: 'Close'};
var _user$project$ATS9462$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$ATS9462$SendJson = {ctor: 'SendJson'};
var _user$project$ATS9462$update = F3(
			...
			switch (_p0.ctor) {
				case 'ToggleActive':
					if (instrument.active) {
						var _v1 = $default,
							_v2 = _user$project$ATS9462$SendJson,
							_v3 = $default;
						$default = _v1;
						msg = _v2;
						instrument = _v3;
						...
						var _v4 = $default,
							_v5 = _user$project$ATS9462$SendJson,
				...
				case 'ChangeName':
					var _v7 = $default,
						_v8 = _user$project$ATS9462$SendJson,
						_v9 = $default;
					$default = _v7;
					msg = _v8;
					instrument = _v9;
				...
				case 'ChangePriority':
					var _v10 = $default,
						_v11 = _user$project$ATS9462$SendJson,
				...
				case 'ChangeConfig':
					var _v13 = $default,
						_v14 = _user$project$ATS9462$SendJson,
				...
				case 'SendJson':
					return {
						ctor: '_Tuple2',
						_0: instrument,
						_1: _user$project$ATS9462$config(
							A2(_user$project$ATS9462$toJson, $default, instrument))
					};
				case 'UpdateProgress':
					...
					if (_p1.ctor === 'Err') {
						...
						if (_p3.active) {
							...
							if (_p2.ctor === 'Err') {
								...
								var _v18 = $default,
									_v19 = _user$project$ATS9462$SendJson,
									_v20 = {
									active: _p3.active,
							...
							var _v21 = $default,
								_v22 = _user$project$ATS9462$SendJson,
								_v23 = $default;
							$default = _v21;
							msg = _v22;
							instrument = _v23;
				...
				default:
					var _p4 = A3(_user$project$ATS9462$update, $default, _user$project$ATS9462$SendJson, $default);
					var model = _p4._0;
					...
					return A2(
						...
						model,
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$ATS9462$removePlugin(instrument.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						});
			}
...
var _user$project$ATS9462$ChangeConfig = function (a) {
	return {ctor: 'ChangeConfig', _0: a};
};
var _user$project$ATS9462$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$ATS9462$nameView = function (instrument) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$floatField, 'Priority', instrument.priority, _user$project$ATS9462$ChangePriority),
			_1: {
				ctor: '::',
				_0: A4(
					...
					function (_p5) {
						return _user$project$ATS9462$ChangeConfig(
...
var _user$project$ATS9462$ChangeName = function (a) {
	return {ctor: 'ChangeName', _0: a};
};
var _user$project$ATS9462$ToggleActive = {ctor: 'ToggleActive'};
var _user$project$ATS9462$view = F2(
	function (options, instrument) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			A7(_user$project$PluginHelpers$titleWithAttributions, instrument.metadata.title, instrument.active, _user$project$ATS9462$ToggleActive, _user$project$ATS9462$Close, instrument.metadata.authors, instrument.metadata.maintainer, instrument.metadata.email),
			instrument.active ? {
				ctor: '::',
				_0: _user$project$ATS9462$nameView(instrument),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$map,
						_user$project$ATS9462$ChangeConfig,
...
var _user$project$ATS9462$main = function () {
	var model = _user$project$ATS9462Config$default(_user$project$ATS9462$common);
	return _elm_lang$html$Html$program(
		{
			...
			view: function (instrument) {
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					A2(_user$project$ATS9462$view, _user$project$ATS9462Config$options, instrument));
			},
			update: _user$project$ATS9462$update(model),
			subscriptions: _elm_lang$core$Basics$always(
				_user$project$ATS9462$processProgress(_user$project$ATS9462$UpdateProgress))
		});
}()();
