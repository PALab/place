...
var _user$project$LabJack$encode = function (model) {
	return {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'null', _1: _elm_lang$core$Json_Encode$null},
		_1: {ctor: '[]'}
	};
};
var _user$project$LabJack$userInteractionsView = function (model) {
	return {ctor: '[]'};
};
var _user$project$LabJack$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$LabJack$default = {
	$null: {ctor: '_Tuple0'}
};
var _user$project$LabJack$common = {
	title: 'LabJack',
	authors: {
		ctor: '::',
		_0: 'Dr. A. Place',
	...
	elm: {moduleName: 'LabJack'},
	python: {moduleName: 'labjack_t_series', className: 'LabJack'},
	defaultPriority: '10'
};
var _user$project$LabJack$defaultModel = {active: false, priority: _user$project$LabJack$common.defaultPriority, metadata: _user$project$LabJack$common, config: _user$project$LabJack$default, progress: _elm_lang$core$Json_Encode$null};
var _user$project$LabJack$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$LabJack$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
var _user$project$LabJack$processProgress = _elm_lang$core$Native_Platform.incomingPort('processProgress', _elm_lang$core$Json_Decode$value);
var _user$project$LabJack$Model = function (a) {
	return {$null: a};
};
var _user$project$LabJack$decode = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'null',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}),
	_elm_lang$core$Json_Decode$succeed(_user$project$LabJack$Model));
var _user$project$LabJack$PluginModel = F5(
	function (a, b, c, d, e) {
		return {active: a, priority: b, metadata: c, config: d, progress: e};
	});
var _user$project$LabJack$Null = {ctor: 'Null'};
var _user$project$LabJack$Close = {ctor: 'Close'};
var _user$project$LabJack$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$LabJack$SendToPlace = {ctor: 'SendToPlace'};
var _user$project$LabJack$ChangePlugin = function (a) {
	return {ctor: 'ChangePlugin', _0: a};
};
var _user$project$LabJack$updatePlugin = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'ToggleActive':
				return model.active ? _user$project$LabJack$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: false})) : _user$project$LabJack$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: true}));
			case 'ChangePriority':
				return _user$project$LabJack$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{priority: _p1._0}));
			case 'ChangePlugin':
				var _p2 = A2(_user$project$LabJack$update, _p1._0, model.config);
				var newConfig = _p2._0;
				var cmd = _p2._1;
				var newCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$LabJack$ChangePlugin, cmd);
				var _p3 = _user$project$LabJack$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{config: newConfig}));
			...
			case 'SendToPlace':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$LabJack$config(
									...
									_1: _user$project$Plugin$encode(
										{
											...
											metadata: _user$project$LabJack$common,
											config: _elm_lang$core$Json_Encode$object(
												_user$project$LabJack$encode(model.config)),
			...
			case 'UpdateProgress':
				...
				if (_p4.ctor === 'Err') {
					...
					var _p6 = _p4._0;
					if (_p6.active) {
						var _p5 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$LabJack$decode, _p6.config);
						if (_p5.ctor === 'Err') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
						...
						return _user$project$LabJack$newModel(_user$project$LabJack$defaultModel);
					}
				}
			default:
				var _p7 = _user$project$LabJack$newModel(_user$project$LabJack$defaultModel);
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$LabJack$removePlugin(model.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						})
				};
...
var _user$project$LabJack$newModel = function (model) {
	return A2(_user$project$LabJack$updatePlugin, _user$project$LabJack$SendToPlace, model);
};
var _user$project$LabJack$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$LabJack$ToggleActive = {ctor: 'ToggleActive'};
var _user$project$LabJack$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A7(_user$project$PluginHelpers$titleWithAttributions, _user$project$LabJack$common.title, model.active, _user$project$LabJack$ToggleActive, _user$project$LabJack$Close, _user$project$LabJack$common.authors, _user$project$LabJack$common.maintainer, _user$project$LabJack$common.email),
		model.active ? {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$integerField, 'Priority', model.priority, _user$project$LabJack$ChangePriority),
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_elm_lang$html$Html$map(_user$project$LabJack$ChangePlugin),
					_user$project$LabJack$userInteractionsView(model.config)),
				{
					ctor: '::',
...
var _user$project$LabJack$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$LabJack$defaultModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: function (model) {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				_user$project$LabJack$viewModel(model));
		},
		update: _user$project$LabJack$updatePlugin,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$LabJack$processProgress(_user$project$LabJack$UpdateProgress))
	})();

var Elm = {};
Elm['LabJack'] = Elm['LabJack'] || {};
if (typeof _user$project$LabJack$main !== 'undefined') {
    _user$project$LabJack$main(Elm['LabJack'], 'LabJack', undefined);
}
