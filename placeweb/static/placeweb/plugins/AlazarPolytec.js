		...
		_1: {
			...
			_0: {
				...
				_1: function () {
					...
					switch (_p0) {
						case 'ATS660':
							return A2(_user$project$AlazarConfig$toJson, _user$project$ATS660Config$defaultConfig, model.alazarTechConfig);
						case 'ATS9440':
							return A2(_user$project$AlazarConfig$toJson, _user$project$ATS9440Config$defaultConfig, model.alazarTechConfig);
						case 'ATS9462':
							return A2(_user$project$AlazarConfig$toJson, _user$project$ATS9462Config$defaultConfig, model.alazarTechConfig);
						default:
							return A2(_user$project$AlazarConfig$toJson, _user$project$ATS660Config$defaultConfig, model.alazarTechConfig);
					}
				}()
			...
			_1: {
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$object(
						_user$project$PolytecConfig$encode(model.polytecModel))
				},
				_1: {ctor: '[]'}
			}
		}
...
var _user$project$AlazarPolytec$default = {alazarTechBoard: 'ATS660', alazarTechConfig: _user$project$ATS660Config$defaultConfig, polytecModel: _user$project$PolytecConfig$default};
...
var _user$project$AlazarPolytec$decode = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'polytecModel',
	_user$project$PolytecConfig$decode,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'alazarTechConfig',
		_user$project$AlazarConfig$fromJson,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'alazarTechBoard',
			_elm_lang$core$Json_Decode$string,
...
var _user$project$AlazarPolytec$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							...
							alazarTechConfig: function () {
								...
								switch (_p2) {
									case 'ATS660':
										return _user$project$ATS660Config$defaultConfig;
									case 'ATS9440':
										return _user$project$ATS9440Config$defaultConfig;
									case 'ATS9462':
										return _user$project$ATS9462Config$defaultConfig;
									default:
										return _user$project$ATS660Config$defaultConfig;
								}
							}()
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							alazarTechConfig: function () {
								...
								switch (_p4) {
									case 'ATS660':
										return A3(_user$project$AlazarConfig$update, _user$project$ATS660Config$defaultConfig, _p5, model.alazarTechConfig);
									case 'ATS9440':
										return A3(_user$project$AlazarConfig$update, _user$project$ATS9440Config$defaultConfig, _p5, model.alazarTechConfig);
									case 'ATS9462':
										return A3(_user$project$AlazarConfig$update, _user$project$ATS9462Config$defaultConfig, _p5, model.alazarTechConfig);
									default:
										return A3(_user$project$AlazarConfig$update, _user$project$ATS660Config$defaultConfig, _p5, model.alazarTechConfig);
								}
							}()
			...
			default:
				var _p6 = A2(_user$project$PolytecConfig$update, _p1._0, model.polytecModel);
...
var _user$project$AlazarPolytec$userInteractionsView = function (model) {
	return A2(
			...
			_1: {
				...
				_0: A2(
					...
					function () {
						...
						switch (_p7) {
							case 'ATS660':
								return A2(_user$project$AlazarConfig$view, _user$project$ATS660Config$options, model.alazarTechConfig);
							case 'ATS9440':
								return A2(_user$project$AlazarConfig$view, _user$project$ATS9440Config$options, model.alazarTechConfig);
							case 'ATS9462':
								return A2(_user$project$AlazarConfig$view, _user$project$ATS9462Config$options, model.alazarTechConfig);
							default:
								return A2(_user$project$AlazarConfig$view, _user$project$ATS660Config$options, model.alazarTechConfig);
						}
					}()),
		...
		A2(
			...
			_user$project$PolytecConfig$userInteractionsView(model.polytecModel)));
};
