...
var _user$project$PlaceTimer$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeIntervalType':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{waitLastUpdate: !model.waitLastUpdate}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
var _user$project$PlaceTimer$common = {
	...
	elm: {moduleName: 'PlaceTimer'},
	python: {moduleName: 'place_timer', className: 'PlaceTimer'},
	defaultPriority: '110'
};
var _user$project$PlaceTimer$defaultModel = {active: false, priority: _user$project$PlaceTimer$common.defaultPriority, metadata: _user$project$PlaceTimer$common, config: _user$project$PlaceTimer$default, progress: _elm_lang$core$Json_Encode$null};
var _user$project$PlaceTimer$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$PlaceTimer$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
...
var _user$project$PlaceTimer$ChangeIntervalType = function (a) {
	return {ctor: 'ChangeIntervalType', _0: a};
};
var _user$project$PlaceTimer$selectType = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
			_0: A4(
				...
				'Timer Type',
				model.intervalType,
				_user$project$PlaceTimer$ChangeIntervalType,
				{
					ctor: '::',
...
var _user$project$PlaceTimer$userInteractionsView = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$PlaceTimer$selectType(model),
		{
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$checkbox, 'Wait on last update', model.waitLastUpdate, _user$project$PlaceTimer$ToggleWaitLastUpdate),
			_1: {ctor: '[]'}
		});
};
var _user$project$PlaceTimer$Close = {ctor: 'Close'};
var _user$project$PlaceTimer$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$PlaceTimer$SendToPlace = {ctor: 'SendToPlace'};
var _user$project$PlaceTimer$ChangePlugin = function (a) {
	return {ctor: 'ChangePlugin', _0: a};
};
var _user$project$PlaceTimer$updatePlugin = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'ToggleActive':
				return model.active ? _user$project$PlaceTimer$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: false})) : _user$project$PlaceTimer$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: true}));
			case 'ChangePriority':
				return _user$project$PlaceTimer$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{priority: _p2._0}));
			case 'ChangePlugin':
				var _p3 = A2(_user$project$PlaceTimer$update, _p2._0, model.config);
				var newConfig = _p3._0;
				var cmd = _p3._1;
				var newCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$PlaceTimer$ChangePlugin, cmd);
				var _p4 = _user$project$PlaceTimer$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{config: newConfig}));
			...
			case 'SendToPlace':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$PlaceTimer$config(
									...
									_1: _user$project$Plugin$encode(
										{
											...
											metadata: _user$project$PlaceTimer$common,
											config: _elm_lang$core$Json_Encode$object(
												_user$project$PlaceTimer$encode(model.config)),
			...
			case 'UpdateProgress':
				...
				if (_p5.ctor === 'Err') {
					...
					var _p7 = _p5._0;
					if (_p7.active) {
						var _p6 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$PlaceTimer$decode, _p7.config);
						if (_p6.ctor === 'Err') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
						...
						return _user$project$PlaceTimer$newModel(_user$project$PlaceTimer$defaultModel);
					}
				}
			default:
				var _p8 = _user$project$PlaceTimer$newModel(_user$project$PlaceTimer$defaultModel);
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$PlaceTimer$removePlugin(model.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						})
				};
...
var _user$project$PlaceTimer$newModel = function (model) {
	return A2(_user$project$PlaceTimer$updatePlugin, _user$project$PlaceTimer$SendToPlace, model);
};
var _user$project$PlaceTimer$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$PlaceTimer$ToggleActive = {ctor: 'ToggleActive'};
var _user$project$PlaceTimer$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A7(_user$project$PluginHelpers$titleWithAttributions, _user$project$PlaceTimer$common.title, model.active, _user$project$PlaceTimer$ToggleActive, _user$project$PlaceTimer$Close, _user$project$PlaceTimer$common.authors, _user$project$PlaceTimer$common.maintainer, _user$project$PlaceTimer$common.email),
		model.active ? {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$integerField, 'Priority', model.priority, _user$project$PlaceTimer$ChangePriority),
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_elm_lang$html$Html$map(_user$project$PlaceTimer$ChangePlugin),
					_user$project$PlaceTimer$userInteractionsView(model.config)),
				{
					ctor: '::',
...
var _user$project$PlaceTimer$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$PlaceTimer$defaultModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: function (model) {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				_user$project$PlaceTimer$viewModel(model));
		},
		update: _user$project$PlaceTimer$updatePlugin,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$PlaceTimer$processProgress(_user$project$PlaceTimer$UpdateProgress))
	})();

var Elm = {};
Elm['PlaceTimer'] = Elm['PlaceTimer'] || {};
if (typeof _user$project$PlaceTimer$main !== 'undefined') {
    _user$project$PlaceTimer$main(Elm['PlaceTimer'], 'PlaceTimer', undefined);
}
