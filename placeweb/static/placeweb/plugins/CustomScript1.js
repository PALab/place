...
var _user$project$CustomScript1$encode = function (model) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$CustomScript1$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
...
var _user$project$CustomScript1$default = {configScriptPath: '', updateScriptPath: '', cleanupScriptPath: ''};
var _user$project$CustomScript1$common = {
	...
	elm: {moduleName: 'CustomScript1'},
	python: {moduleName: 'custom_script_1', className: 'CustomScript1'},
	defaultPriority: '999'
};
var _user$project$CustomScript1$defaultModel = {active: false, priority: _user$project$CustomScript1$common.defaultPriority, metadata: _user$project$CustomScript1$common, config: _user$project$CustomScript1$default, progress: _elm_lang$core$Json_Encode$null};
var _user$project$CustomScript1$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$CustomScript1$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
var _user$project$CustomScript1$processProgress = _elm_lang$core$Native_Platform.incomingPort('processProgress', _elm_lang$core$Json_Decode$value);
var _user$project$CustomScript1$Model = F3(
	function (a, b, c) {
		return {configScriptPath: a, updateScriptPath: b, cleanupScriptPath: c};
	});
var _user$project$CustomScript1$decode = A3(
	...
	A3(
		...
		A3(
			...
			'config_script_path',
			_elm_lang$core$Json_Decode$string,
			_elm_lang$core$Json_Decode$succeed(_user$project$CustomScript1$Model))));
var _user$project$CustomScript1$PluginModel = F5(
	function (a, b, c, d, e) {
		return {active: a, priority: b, metadata: c, config: d, progress: e};
	});
...
var _user$project$CustomScript1$userInteractionsView = function (model) {
	return {
		ctor: '::',
		_0: A3(_user$project$PluginHelpers$stringField, 'Config script path', model.configScriptPath, _user$project$CustomScript1$ChangeConfigScriptPath),
		_1: {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$stringField, 'Update script path', model.updateScriptPath, _user$project$CustomScript1$ChangeUpdateScriptPath),
			_1: {
				ctor: '::',
				_0: A3(_user$project$PluginHelpers$stringField, 'Cleanup script path', model.cleanupScriptPath, _user$project$CustomScript1$ChangeCleanupScriptPath),
				_1: {ctor: '[]'}
			}
		}
	};
...
var _user$project$CustomScript1$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$CustomScript1$SendToPlace = {ctor: 'SendToPlace'};
var _user$project$CustomScript1$ChangePlugin = function (a) {
	return {ctor: 'ChangePlugin', _0: a};
};
var _user$project$CustomScript1$updatePlugin = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'ToggleActive':
				return model.active ? _user$project$CustomScript1$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: false})) : _user$project$CustomScript1$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: true}));
			case 'ChangePriority':
				return _user$project$CustomScript1$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{priority: _p1._0}));
			case 'ChangePlugin':
				var _p2 = A2(_user$project$CustomScript1$update, _p1._0, model.config);
				var newConfig = _p2._0;
				var cmd = _p2._1;
				var newCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$CustomScript1$ChangePlugin, cmd);
				var _p3 = _user$project$CustomScript1$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{config: newConfig}));
			...
			case 'SendToPlace':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$CustomScript1$config(
									...
									_1: _user$project$Plugin$encode(
										{
											...
											metadata: _user$project$CustomScript1$common,
											config: _elm_lang$core$Json_Encode$object(
												_user$project$CustomScript1$encode(model.config)),
			...
			case 'UpdateProgress':
				...
				if (_p4.ctor === 'Err') {
					...
					var _p6 = _p4._0;
					if (_p6.active) {
						var _p5 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$CustomScript1$decode, _p6.config);
						if (_p5.ctor === 'Err') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
						...
						return _user$project$CustomScript1$newModel(_user$project$CustomScript1$defaultModel);
					}
				}
			default:
				var _p7 = _user$project$CustomScript1$newModel(_user$project$CustomScript1$defaultModel);
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$CustomScript1$removePlugin(model.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						})
				};
...
var _user$project$CustomScript1$newModel = function (model) {
	return A2(_user$project$CustomScript1$updatePlugin, _user$project$CustomScript1$SendToPlace, model);
};
...
var _user$project$CustomScript1$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A7(_user$project$PluginHelpers$titleWithAttributions, _user$project$CustomScript1$common.title, model.active, _user$project$CustomScript1$ToggleActive, _user$project$CustomScript1$Close, _user$project$CustomScript1$common.authors, _user$project$CustomScript1$common.maintainer, _user$project$CustomScript1$common.email),
		model.active ? {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$integerField, 'Priority', model.priority, _user$project$CustomScript1$ChangePriority),
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_elm_lang$html$Html$map(_user$project$CustomScript1$ChangePlugin),
					_user$project$CustomScript1$userInteractionsView(model.config)),
				{
					ctor: '::',
...
var _user$project$CustomScript1$main = _elm_lang$html$Html$program(
	{
		...
		update: _user$project$CustomScript1$updatePlugin,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$CustomScript1$processProgress(_user$project$CustomScript1$UpdateProgress))
	})();
