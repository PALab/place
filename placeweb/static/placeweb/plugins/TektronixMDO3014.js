...
var _user$project$TektronixMDO3014$encode = function (model) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$TektronixMDO3014$update = F2(
	function (msg, model) {
		var _p0 = msg;
...
var _user$project$TektronixMDO3014$default = {plot: false, forceTrigger: true};
var _user$project$TektronixMDO3014$common = {
	title: 'Tektronix MDO3014 Oscilloscope',
	authors: {
		ctor: '::',
		_0: 'Paul Freeman',
		_1: {ctor: '[]'}
	...
	elm: {moduleName: 'TektronixMDO3014'},
	python: {moduleName: 'tektronix', className: 'MDO3014'},
	defaultPriority: '100'
};
var _user$project$TektronixMDO3014$defaultModel = {active: false, priority: _user$project$TektronixMDO3014$common.defaultPriority, metadata: _user$project$TektronixMDO3014$common, config: _user$project$TektronixMDO3014$default, progress: _elm_lang$core$Json_Encode$null};
var _user$project$TektronixMDO3014$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$TektronixMDO3014$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
...
var _user$project$TektronixMDO3014$Model = F2(
	function (a, b) {
		return {plot: a, forceTrigger: b};
	});
var _user$project$TektronixMDO3014$decode = A3(
	...
	A3(
		...
		'plot',
		_elm_lang$core$Json_Decode$bool,
		_elm_lang$core$Json_Decode$succeed(_user$project$TektronixMDO3014$Model)));
var _user$project$TektronixMDO3014$PluginModel = F5(
	function (a, b, c, d, e) {
		return {active: a, priority: b, metadata: c, config: d, progress: e};
	});
var _user$project$TektronixMDO3014$ToggleTrigger = {ctor: 'ToggleTrigger'};
var _user$project$TektronixMDO3014$TogglePlot = {ctor: 'TogglePlot'};
var _user$project$TektronixMDO3014$userInteractionsView = function (model) {
	return {
		ctor: '::',
		_0: A3(_user$project$PluginHelpers$checkbox, 'Plot', model.plot, _user$project$TektronixMDO3014$TogglePlot),
		_1: {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$checkbox, 'Force Trigger', model.forceTrigger, _user$project$TektronixMDO3014$ToggleTrigger),
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$TektronixMDO3014$Close = {ctor: 'Close'};
var _user$project$TektronixMDO3014$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$TektronixMDO3014$SendToPlace = {ctor: 'SendToPlace'};
var _user$project$TektronixMDO3014$ChangePlugin = function (a) {
	return {ctor: 'ChangePlugin', _0: a};
};
var _user$project$TektronixMDO3014$updatePlugin = F2(
	function (msg, model) {
		var _p1 = msg;
		switch (_p1.ctor) {
			case 'ToggleActive':
				return model.active ? _user$project$TektronixMDO3014$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: false})) : _user$project$TektronixMDO3014$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: true}));
			case 'ChangePriority':
				return _user$project$TektronixMDO3014$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{priority: _p1._0}));
			case 'ChangePlugin':
				var _p2 = A2(_user$project$TektronixMDO3014$update, _p1._0, model.config);
				var newConfig = _p2._0;
				var cmd = _p2._1;
				var newCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$TektronixMDO3014$ChangePlugin, cmd);
				var _p3 = _user$project$TektronixMDO3014$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{config: newConfig}));
			...
			case 'SendToPlace':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$TektronixMDO3014$config(
									...
									_1: _user$project$Plugin$encode(
										{
											...
											metadata: _user$project$TektronixMDO3014$common,
											config: _elm_lang$core$Json_Encode$object(
												_user$project$TektronixMDO3014$encode(model.config)),
			...
			case 'UpdateProgress':
				...
				if (_p4.ctor === 'Err') {
					...
					var _p6 = _p4._0;
					if (_p6.active) {
						var _p5 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$TektronixMDO3014$decode, _p6.config);
						if (_p5.ctor === 'Err') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
						...
						return _user$project$TektronixMDO3014$newModel(_user$project$TektronixMDO3014$defaultModel);
					}
				}
			default:
				var _p7 = _user$project$TektronixMDO3014$newModel(_user$project$TektronixMDO3014$defaultModel);
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$TektronixMDO3014$removePlugin(model.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						})
				};
...
var _user$project$TektronixMDO3014$newModel = function (model) {
	return A2(_user$project$TektronixMDO3014$updatePlugin, _user$project$TektronixMDO3014$SendToPlace, model);
};
var _user$project$TektronixMDO3014$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$TektronixMDO3014$ToggleActive = {ctor: 'ToggleActive'};
var _user$project$TektronixMDO3014$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A7(_user$project$PluginHelpers$titleWithAttributions, _user$project$TektronixMDO3014$common.title, model.active, _user$project$TektronixMDO3014$ToggleActive, _user$project$TektronixMDO3014$Close, _user$project$TektronixMDO3014$common.authors, _user$project$TektronixMDO3014$common.maintainer, _user$project$TektronixMDO3014$common.email),
		model.active ? {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$integerField, 'Priority', model.priority, _user$project$TektronixMDO3014$ChangePriority),
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_elm_lang$html$Html$map(_user$project$TektronixMDO3014$ChangePlugin),
					_user$project$TektronixMDO3014$userInteractionsView(model.config)),
				{
					ctor: '::',
...
var _user$project$TektronixMDO3014$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$TektronixMDO3014$defaultModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: function (model) {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				_user$project$TektronixMDO3014$viewModel(model));
		},
		update: _user$project$TektronixMDO3014$updatePlugin,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$TektronixMDO3014$processProgress(_user$project$TektronixMDO3014$UpdateProgress))
	})();
