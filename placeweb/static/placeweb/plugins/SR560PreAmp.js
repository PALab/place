...
var _user$project$SR560PreAmp$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeBlanking':
...
var _user$project$SR560PreAmp$default = {blanking: 'not blanked', coupling: 'DC', reserve: 'calibration gains', mode: 'bypass', gain: '1', highpass: '0.03 Hz', lowpass: '1 MHz', invert: 'non-inverted', source: 'A', vGainStat: 'calibrated gain', vGain: '20'};
var _user$project$SR560PreAmp$encode = function (model) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
											...
											_1: {
												...
												_0: {
													...
													_1: _elm_lang$core$Json_Encode$int(
														A2(_user$project$PluginHelpers$intDefault, _user$project$SR560PreAmp$default.vGain, model.vGain))
												},
												_1: {ctor: '[]'}
											}
										}
...
var _user$project$SR560PreAmp$common = {
	...
	elm: {moduleName: 'SR560PreAmp'},
	python: {moduleName: 'sr560_preamp', className: 'SR560PreAmp'},
	defaultPriority: '10'
};
var _user$project$SR560PreAmp$defaultModel = {active: false, priority: _user$project$SR560PreAmp$common.defaultPriority, metadata: _user$project$SR560PreAmp$common, config: _user$project$SR560PreAmp$default, progress: _elm_lang$core$Json_Encode$null};
var _user$project$SR560PreAmp$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$SR560PreAmp$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
var _user$project$SR560PreAmp$processProgress = _elm_lang$core$Native_Platform.incomingPort('processProgress', _elm_lang$core$Json_Decode$value);
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {blanking: a, coupling: b, reserve: c, mode: d, gain: e, highpass: f, lowpass: g, invert: h, source: i, vGainStat: j, vGain: k};
										};
									};
								};
							};
								...
								A3(
									...
									A3(
										...
										A3(
											...
											'blanking',
											_elm_lang$core$Json_Decode$string,
											_elm_lang$core$Json_Decode$succeed(_user$project$SR560PreAmp$Model))))))))))));
var _user$project$SR560PreAmp$PluginModel = F5(
	function (a, b, c, d, e) {
		return {active: a, priority: b, metadata: c, config: d, progress: e};
	});
...
var _user$project$SR560PreAmp$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$SR560PreAmp$SendToPlace = {ctor: 'SendToPlace'};
var _user$project$SR560PreAmp$ChangePlugin = function (a) {
		...
		switch (_p1.ctor) {
			case 'ToggleActive':
				return model.active ? _user$project$SR560PreAmp$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: false})) : _user$project$SR560PreAmp$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: true}));
			case 'ChangePriority':
			...
			case 'SendToPlace':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$SR560PreAmp$config(
									...
									_1: _user$project$Plugin$encode(
										{
											...
											config: _elm_lang$core$Json_Encode$object(
												_user$project$SR560PreAmp$encode(model.config)),
			...
			case 'UpdateProgress':
				...
				if (_p4.ctor === 'Err') {
					...
					if (_p6.active) {
						...
						return _user$project$SR560PreAmp$newModel(_user$project$SR560PreAmp$defaultModel);
					}
				}
			default:
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$SR560PreAmp$removePlugin(model.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						})
				};
...
var _user$project$SR560PreAmp$newModel = function (model) {
	return A2(_user$project$SR560PreAmp$updatePlugin, _user$project$SR560PreAmp$SendToPlace, model);
};
...
var _user$project$SR560PreAmp$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A7(_user$project$PluginHelpers$titleWithAttributions, _user$project$SR560PreAmp$common.title, model.active, _user$project$SR560PreAmp$ToggleActive, _user$project$SR560PreAmp$Close, _user$project$SR560PreAmp$common.authors, _user$project$SR560PreAmp$common.maintainer, _user$project$SR560PreAmp$common.email),
		model.active ? {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$integerField, 'Priority', model.priority, _user$project$SR560PreAmp$ChangePriority),
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_elm_lang$html$Html$map(_user$project$SR560PreAmp$ChangePlugin),
					_user$project$SR560PreAmp$userInteractionsView(model.config)),
				{
					ctor: '::',
...
var _user$project$SR560PreAmp$main = _elm_lang$html$Html$program(
	{
		...
		update: _user$project$SR560PreAmp$updatePlugin,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$SR560PreAmp$processProgress(_user$project$SR560PreAmp$UpdateProgress))
	})();
