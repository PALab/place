...
var _user$project$EquilibarEPR3000$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeStart':
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{end_true: !model.end_true, end_pressure: model.start_pressure}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$EquilibarEPR3000$default = {start_pressure: '0.0', end_pressure: '0.0', units: 'MPa', end_true: false};
var _user$project$EquilibarEPR3000$encode = function (model) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			...
			_1: _elm_lang$core$Json_Encode$float(
				A2(_user$project$PluginHelpers$floatDefault, _user$project$EquilibarEPR3000$default.start_pressure, model.start_pressure))
		},
		_1: {
			ctor: '::',
			_0: {
				...
				_0: 'end_pressure',
				_1: _elm_lang$core$Json_Encode$float(
					A2(_user$project$PluginHelpers$floatDefault, _user$project$EquilibarEPR3000$default.end_pressure, model.end_pressure))
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'units',
					_1: _elm_lang$core$Json_Encode$string(model.units)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'end_true',
						_1: _elm_lang$core$Json_Encode$bool(model.end_true)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$EquilibarEPR3000$common = {
	...
	elm: {moduleName: 'EquilibarEPR3000'},
	python: {moduleName: 'equilibar', className: 'EquilibarEPR3000'},
	defaultPriority: '0'
};
var _user$project$EquilibarEPR3000$defaultModel = {active: false, priority: _user$project$EquilibarEPR3000$common.defaultPriority, metadata: _user$project$EquilibarEPR3000$common, config: _user$project$EquilibarEPR3000$default, progress: _elm_lang$core$Json_Encode$null};
var _user$project$EquilibarEPR3000$config = _elm_lang$core$Native_Platform.outgoingPort(
	'config',
	function (v) {
		return v;
	});
var _user$project$EquilibarEPR3000$removePlugin = _elm_lang$core$Native_Platform.outgoingPort(
	'removePlugin',
	function (v) {
		return v;
	});
var _user$project$EquilibarEPR3000$processProgress = _elm_lang$core$Native_Platform.incomingPort('processProgress', _elm_lang$core$Json_Decode$value);
var _user$project$EquilibarEPR3000$Model = F4(
	function (a, b, c, d) {
		return {start_pressure: a, end_pressure: b, units: c, end_true: d};
	});
var _user$project$EquilibarEPR3000$decode = A3(
		...
		A3(
			...
			A3(
				...
				A2(
					...
					_elm_lang$core$Json_Decode$float),
				_elm_lang$core$Json_Decode$succeed(_user$project$EquilibarEPR3000$Model)))));
var _user$project$EquilibarEPR3000$PluginModel = F5(
	function (a, b, c, d, e) {
		return {active: a, priority: b, metadata: c, config: d, progress: e};
	});
var _user$project$EquilibarEPR3000$ToggleEnd = {ctor: 'ToggleEnd'};
var _user$project$EquilibarEPR3000$ChangeUnits = function (a) {
	return {ctor: 'ChangeUnits', _0: a};
};
var _user$project$EquilibarEPR3000$ChangeEnd = function (a) {
	return {ctor: 'ChangeEnd', _0: a};
};
var _user$project$EquilibarEPR3000$ChangeStart = function (a) {
	return {ctor: 'ChangeStart', _0: a};
};
var _user$project$EquilibarEPR3000$userInteractionsView = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$floatField, 'Start pressure', model.start_pressure, _user$project$EquilibarEPR3000$ChangeStart),
			_1: {
				ctor: '::',
				_0: A3(_user$project$PluginHelpers$checkbox, 'Go to pressure at end', model.end_true, _user$project$EquilibarEPR3000$ToggleEnd),
				_1: {ctor: '[]'}
			}
		},
		A2(
			...
			model.end_true ? {
				ctor: '::',
				_0: A3(_user$project$PluginHelpers$floatField, 'End pressure', model.end_pressure, _user$project$EquilibarEPR3000$ChangeEnd),
				_1: {ctor: '[]'}
			} : {ctor: '[]'},
			{
				ctor: '::',
				_0: A4(
					...
					'Units',
					model.units,
					_user$project$EquilibarEPR3000$ChangeUnits,
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'MPa', _1: 'MPa'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'psi', _1: 'psi'},
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$EquilibarEPR3000$Close = {ctor: 'Close'};
var _user$project$EquilibarEPR3000$UpdateProgress = function (a) {
	return {ctor: 'UpdateProgress', _0: a};
};
var _user$project$EquilibarEPR3000$SendToPlace = {ctor: 'SendToPlace'};
var _user$project$EquilibarEPR3000$ChangePlugin = function (a) {
	return {ctor: 'ChangePlugin', _0: a};
};
var _user$project$EquilibarEPR3000$updatePlugin = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'ToggleActive':
				return model.active ? _user$project$EquilibarEPR3000$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: false})) : _user$project$EquilibarEPR3000$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{active: true}));
			case 'ChangePriority':
				return _user$project$EquilibarEPR3000$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{priority: _p3._0}));
			case 'ChangePlugin':
				var _p4 = A2(_user$project$EquilibarEPR3000$update, _p3._0, model.config);
				var newConfig = _p4._0;
				var cmd = _p4._1;
				var newCmd = A2(_elm_lang$core$Platform_Cmd$map, _user$project$EquilibarEPR3000$ChangePlugin, cmd);
				var _p5 = _user$project$EquilibarEPR3000$newModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{config: newConfig}));
			...
			case 'SendToPlace':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$EquilibarEPR3000$config(
									...
									_1: _user$project$Plugin$encode(
										{
											...
											metadata: _user$project$EquilibarEPR3000$common,
											config: _elm_lang$core$Json_Encode$object(
												_user$project$EquilibarEPR3000$encode(model.config)),
			...
			case 'UpdateProgress':
				...
				if (_p6.ctor === 'Err') {
					...
					var _p8 = _p6._0;
					if (_p8.active) {
						var _p7 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$EquilibarEPR3000$decode, _p8.config);
						if (_p7.ctor === 'Err') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
						...
						return _user$project$EquilibarEPR3000$newModel(_user$project$EquilibarEPR3000$defaultModel);
					}
				}
			default:
				var _p9 = _user$project$EquilibarEPR3000$newModel(_user$project$EquilibarEPR3000$defaultModel);
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						{
							...
							_1: {
								ctor: '::',
								_0: _user$project$EquilibarEPR3000$removePlugin(model.metadata.elm.moduleName),
								_1: {ctor: '[]'}
							}
						})
				};
...
var _user$project$EquilibarEPR3000$newModel = function (model) {
	return A2(_user$project$EquilibarEPR3000$updatePlugin, _user$project$EquilibarEPR3000$SendToPlace, model);
};
var _user$project$EquilibarEPR3000$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$EquilibarEPR3000$ToggleActive = {ctor: 'ToggleActive'};
var _user$project$EquilibarEPR3000$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A7(_user$project$PluginHelpers$titleWithAttributions, _user$project$EquilibarEPR3000$common.title, model.active, _user$project$EquilibarEPR3000$ToggleActive, _user$project$EquilibarEPR3000$Close, _user$project$EquilibarEPR3000$common.authors, _user$project$EquilibarEPR3000$common.maintainer, _user$project$EquilibarEPR3000$common.email),
		model.active ? {
			ctor: '::',
			_0: A3(_user$project$PluginHelpers$integerField, 'Priority', model.priority, _user$project$EquilibarEPR3000$ChangePriority),
			_1: A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
					_elm_lang$core$List$map,
					_elm_lang$html$Html$map(_user$project$EquilibarEPR3000$ChangePlugin),
					_user$project$EquilibarEPR3000$userInteractionsView(model.config)),
				{
					ctor: '::',
...
var _user$project$EquilibarEPR3000$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$EquilibarEPR3000$defaultModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: function (model) {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				_user$project$EquilibarEPR3000$viewModel(model));
		},
		update: _user$project$EquilibarEPR3000$updatePlugin,
		subscriptions: _elm_lang$core$Basics$always(
			_user$project$EquilibarEPR3000$processProgress(_user$project$EquilibarEPR3000$UpdateProgress))
	})();

var Elm = {};
Elm['EquilibarEPR3000'] = Elm['EquilibarEPR3000'] || {};
if (typeof _user$project$EquilibarEPR3000$main !== 'undefined') {
    _user$project$EquilibarEPR3000$main(Elm['EquilibarEPR3000'], 'EquilibarEPR3000', undefined);
}
