...
var _user$project$SR850$defaultModel = {className: 'None', active: false, priority: '10'};
var _user$project$SR850$attributions = {
	authors: {
		ctor: '::',
		_0: 'Paul Freeman',
		_1: {ctor: '[]'}
...
var _user$project$SR850$jsonData = _elm_lang$core$Native_Platform.outgoingPort(
	'jsonData',
	function (v) {
		return v;
	});
	...
	function (msg, model) {
		...
		while (true) {
			...
			switch (_p0.ctor) {
				case 'ToggleActive':
					if (model.active) {
						var _v1 = _user$project$SR850$SendJson,
						...
						var _v3 = _user$project$SR850$SendJson,
							_v4 = _elm_lang$core$Native_Utils.update(
							model,
							{className: 'SR850', active: true});
						msg = _v3;
						model = _v4;
						continue updateModel;
					}
				case 'ChangePriority':
					var _v5 = _user$project$SR850$SendJson,
				...
				case 'SendJson':
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: _user$project$SR850$jsonData(
									...
									_0: _elm_lang$core$Json_Encode$object(
										{
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'module_name',
												_1: _elm_lang$core$Json_Encode$string('sr850_amp')
											},
											_1: {
												ctor: '::',
												_0: {
												...
												_1: {
													...
													_0: {
														...
														_1: _elm_lang$core$Json_Encode$int(
															A2(_user$project$ModuleHelpers$intDefault, _user$project$SR850$defaultModel.priority, model.priority))
													},
													_1: {
														ctor: '::',
														_0: {
...
var _user$project$SR850$ChangePriority = function (a) {
	return {ctor: 'ChangePriority', _0: a};
};
var _user$project$SR850$ToggleActive = {ctor: 'ToggleActive'};
var _user$project$SR850$viewModel = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A5(_user$project$ModuleHelpers$titleWithAttributions, 'SR850 Lock-In Amplifier', model.active, _user$project$SR850$ToggleActive, _user$project$SR850$Close, _user$project$SR850$attributions),
		model.active ? {
			ctor: '::',
...
var _user$project$SR850$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _user$project$SR850$defaultModel, _1: _elm_lang$core$Platform_Cmd$none},
		view: function (model) {
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
...
var Elm = {};
Elm['SR850'] = Elm['SR850'] || {};
if (typeof _user$project$SR850$main !== 'undefined') {
    _user$project$SR850$main(Elm['SR850'], 'SR850', undefined);
}
