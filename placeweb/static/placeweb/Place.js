...
var _PALab$place$PluginHelpers$shapeDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (shape) {
		var _p0 = shape;
		switch (_p0) {
	...
	_elm_lang$core$Json_Decode$string);
var _PALab$place$PluginHelpers$colorDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (color) {
		var _p1 = color;
		switch (_p1) {
	...
	_elm_lang$core$Json_Decode$string);
var _PALab$place$PluginHelpers$imgDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (src) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
...
var _PALab$place$PluginHelpers$pngDecoder = A2(_elm_lang$core$Json_Decode$field, 'image', _PALab$place$PluginHelpers$imgDecoder);
var _PALab$place$PluginHelpers$encode = function (plugin) {
...
var _PALab$place$PluginHelpers$anOption = F2(
	function (str, _p2) {
		var _p3 = _p2;
		var _p4 = _p3._0;
		return A2(
...
var _PALab$place$PluginHelpers$floatRangeCheck = F4(
...
var _PALab$place$PluginHelpers$floatDefault = F2(
...
var _PALab$place$PluginHelpers$intDefault = F2(
	function ($default, value) {
...
var _PALab$place$PluginHelpers$rangeCheck = F4(
...
var _PALab$place$PluginHelpers$dropDownBox = F4(
			...
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_PALab$place$PluginHelpers$anOption(value),
							options)),
					_1: {ctor: '[]'}
				}
			});
	});
var _PALab$place$PluginHelpers$floatStringField = F4(
...
var _PALab$place$PluginHelpers$floatField = F3(
...
var _PALab$place$PluginHelpers$integerField = F3(
	function (description, value, msg) {
		return A2(
			_elm_lang$html$Html$p,
			{ctor: '[]'},
...
var _PALab$place$PluginHelpers$stringField = F3(
	function (description, value, msg) {
		return A2(
			_elm_lang$html$Html$p,
			{ctor: '[]'},
...
var _PALab$place$PluginHelpers$checkbox = F3(
	function (description, value, msg) {
		return A2(
			_elm_lang$html$Html$p,
			{ctor: '[]'},
...
var _PALab$place$PluginHelpers$makeMaintainer = F2(
...
var _PALab$place$PluginHelpers$makeAuthor = function (author) {
	return _elm_lang$html$Html$text(
		A2(_elm_lang$core$Basics_ops['++'], ', ', author));
};
var _PALab$place$PluginHelpers$makeAuthors = function (authors) {
	var lastAuthors = A2(
		_elm_lang$core$Maybe$withDefault,
		{ctor: '[]'},
	...
	return _elm_lang$core$Native_Utils.eq(
		...
		A2(_elm_lang$core$List$map, _PALab$place$PluginHelpers$makeAuthor, lastAuthors));
};
var _PALab$place$PluginHelpers$titleWithAttributions = F7(
									...
									_0: A2(
										...
										A2(
											...
											_elm_lang$core$Native_Utils.eq(
												...
												_1: {ctor: '[]'}
											} : _PALab$place$PluginHelpers$makeAuthors(authors),
											_elm_lang$core$Native_Utils.eq(maintainer, '') ? {ctor: '[]'} : A2(_PALab$place$PluginHelpers$makeMaintainer, maintainer, email))),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _PALab$place$PluginHelpers$title = F4(
	function (title, value, activeMsg, closeMsg) {
		return A7(
			_PALab$place$PluginHelpers$titleWithAttributions,
			title,
			value,
			activeMsg,
			closeMsg,
...
var _PALab$place$PluginHelpers$Plugin = F7(
	function (a, b, c, d, e, f, g) {
		return {pythonModuleName: a, pythonClassName: b, elmModuleName: c, priority: d, dataRegister: e, config: f, progress: g};
	});
var _PALab$place$PluginHelpers$decode = A8(
	_elm_lang$core$Json_Decode$map7,
	_PALab$place$PluginHelpers$Plugin,
...
var _PALab$place$PluginHelpers$Common = F8(
	function (a, b, c, d, e, f, g, h) {
		return {title: a, authors: b, maintainer: c, email: d, url: e, elmModuleName: f, pythonClassName: g, pythonModuleName: h};
	});
var _PALab$place$PluginHelpers$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _PALab$place$PluginHelpers$pointsDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (xlist) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			function (ylist) {
				return _elm_lang$core$Json_Decode$succeed(
					A3(_elm_lang$core$List$map2, _PALab$place$PluginHelpers$Point, xlist, ylist));
			},
			A2(
				_elm_lang$core$Json_Decode$field,
				'y',
	...
	A2(
		...
		'x',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$float)));
var _PALab$place$PluginHelpers$view1Decoder = A2(
	_elm_lang$core$Json_Decode$map,
	A2(
	...
	A2(_elm_lang$core$Json_Decode$field, 'data1', _PALab$place$PluginHelpers$pointsDecoder));
var _PALab$place$PluginHelpers$view2Decoder = A3(
	...
	A2(_elm_lang$core$Json_Decode$field, 'data1', _PALab$place$PluginHelpers$pointsDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'data2', _PALab$place$PluginHelpers$pointsDecoder));
var _PALab$place$PluginHelpers$view3Decoder = A4(
	_elm_lang$core$Json_Decode$map3,
	A2(
	...
	A2(_elm_lang$core$Json_Decode$field, 'data1', _PALab$place$PluginHelpers$pointsDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'data2', _PALab$place$PluginHelpers$pointsDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'data3', _PALab$place$PluginHelpers$pointsDecoder));
var _PALab$place$PluginHelpers$lineDecoder = A5(
	_elm_lang$core$Json_Decode$map4,
	_terezka$line_charts$LineChart$line,
	A2(_elm_lang$core$Json_Decode$field, 'color', _PALab$place$PluginHelpers$colorDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'shape', _PALab$place$PluginHelpers$shapeDecoder),
	A2(_elm_lang$core$Json_Decode$field, 'label', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'data', _PALab$place$PluginHelpers$pointsDecoder));
var _PALab$place$PluginHelpers$dashDecoder = A6(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$float)),
	A2(_elm_lang$core$Json_Decode$field, 'data', _PALab$place$PluginHelpers$pointsDecoder));
var _PALab$place$PluginHelpers$seriesDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (seriesCategory) {
		var _p12 = seriesCategory;
		switch (_p12) {
			case 'line':
				return _PALab$place$PluginHelpers$lineDecoder;
			case 'dash':
				return _PALab$place$PluginHelpers$dashDecoder;
			default:
...
var _PALab$place$PluginHelpers$viewDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	A2(
		_terezka$line_charts$LineChart$view,
		function (_) {
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'series',
		_elm_lang$core$Json_Decode$list(_PALab$place$PluginHelpers$seriesDecoder)));
var _PALab$place$PluginHelpers$itemDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (itemCategory) {
		var _p13 = itemCategory;
		switch (_p13) {
			case 'view1':
				return _PALab$place$PluginHelpers$view1Decoder;
			case 'view2':
				return _PALab$place$PluginHelpers$view2Decoder;
			case 'view3':
				return _PALab$place$PluginHelpers$view3Decoder;
			case 'view':
				return _PALab$place$PluginHelpers$viewDecoder;
			case 'png':
				return _PALab$place$PluginHelpers$pngDecoder;
			default:
				return _elm_lang$core$Json_Decode$fail('item not recognized');
		}
	},
	A2(_elm_lang$core$Json_Decode$field, 'f', _elm_lang$core$Json_Decode$string));
var _PALab$place$PluginHelpers$displayItem = function (_p14) {
	var _p15 = _p14;
	return A2(
			...
			_1: {
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						ctor: '::',
						_0: function () {
							var _p16 = A2(_elm_lang$core$Json_Decode$decodeValue, _PALab$place$PluginHelpers$itemDecoder, _p15._1);
							if (_p16.ctor === 'Ok') {
								return _p16._0;
							} else {
...
var _PALab$place$PluginHelpers$displayAllProgress = function (progress) {
	var _p17 = progress;
	if (_p17.ctor === 'Nothing') {
		...
		if (_p18.ctor === 'Ok') {
			return A2(
				...
				A2(
					_elm_lang$core$List$map,
					_PALab$place$PluginHelpers$displayItem,
...
var _PALab$place$PluginHelpers$Img = F2(
	function (a, b) {
		return {src: a, alt: b};
	});
		...
		A3(
			...
			A2(
				...
				A2(
					_elm_lang$core$List$range,
					1,
					_elm_lang$core$List$length(experiment.plugins)))));
	var width = _elm_lang$core$List$length(allHeadings) + 1;
			...
			_1: {
				...
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: headRow,
						_1: (_elm_lang$core$Native_Utils.cmp(experiment.updates, 5) < 1) ? A2(
							_elm_lang$core$List$map,
							row,
							A2(_elm_lang$core$List$range, 0, experiment.updates)) : {
							ctor: '::',
							_0: row(0),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: row(experiment.updates - 2),
										_1: {
											ctor: '::',
											_0: row(experiment.updates - 1),
											_1: {ctor: '[]'}
										}
									}
								}
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_1: {
				...
				_0: {
					...
					_0: 'plugins',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _PALab$place$PluginHelpers$encode, experiment.plugins))
				},
				_1: {
					ctor: '::',
					_0: {
...
var _PALab$place$Experiment$Experiment = F4(
	function (a, b, c, d) {
...
var _PALab$place$Experiment$decode = A5(
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'plugins',
		_elm_lang$core$Json_Decode$list(_PALab$place$PluginHelpers$decode)),
...
var _PALab$place$Place$dateDecode = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (dateString) {
		var _p0 = _elm_lang$core$Date$fromString(dateString);
		if (_p0.ctor === 'Ok') {
...
var _PALab$place$Place$intDefault = F2(
	function ($default, value) {
		var _p3 = _elm_lang$core$String$toInt(value);
		if (_p3.ctor === 'Ok') {
			return _p3._0;
		} else {
			return A2(
...
var _PALab$place$Place$parseVersion = function (versionStr) {
	var _p4 = A2(_elm_lang$core$String$split, '.', versionStr);
	if ((((_p4.ctor === '::') && (_p4._1.ctor === '::')) && (_p4._1._1.ctor === '::')) && (_p4._1._1._1.ctor === '[]')) {
		var _p5 = A4(
			...
			_elm_lang$core$String$toInt(_p4._1._1._0));
		if (_p5.ctor === 'Ok') {
			return _p5._0;
		} else {
...
var _PALab$place$Place$Result = {ctor: 'Result'};
		...
		switch (_p6) {
			...
			case 'Error':
				return A2(
					...
					function (_p9) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$Place$ServerError(_p9));
					},
...
var _PALab$place$Place$ServerResponse = function (a) {
			...
			switch (_p10.ctor) {
				...
				case 'UpdateExperimentPlugins':
					...
					if (_p11.ctor === 'Ok') {
						...
						var newPlugins = function () {
							var _p12 = _elm_lang$core$List$head(_p15);
							if (_p12.ctor === 'Nothing') {
								return model.experiment.plugins;
							} else {
								var _p14 = _p12._0;
								return A2(
									_elm_lang$core$Basics_ops['++'],
									_elm_lang$core$Native_Utils.eq(_p14.pythonClassName, 'None') ? _PALab$place$Place$emptyPlugins : _p15,
									A2(
										_elm_lang$core$List$filter,
										function (_p13) {
											return A2(
				...
				case 'DeleteExperiment':
					var body = _elm_lang$http$Http$jsonBody(
						_PALab$place$Place$locationEncode(_p10._0));
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
							_elm_lang$http$Http$send,
							_PALab$place$Place$ServerResponse,
				...
				case 'ConfigureNewExperiment':
					return {
						...
						_1: _PALab$place$Place$showPlugins(
							{ctor: '_Tuple0'})
					};
						...
						switch (_p17.ctor) {
							case 'Ready':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{state: _PALab$place$Place$History, history: _p17._0}),
									_1: _PALab$place$Place$hidePlugins(
										{ctor: '_Tuple0'})
								};
							case 'Running':
							...
							case 'ServerError':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											state: _PALab$place$Place$Error(_p17._0)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							default:
...
var _PALab$place$Place$placeGraphic = F3(
	function (currentPhase, updates, animate) {
		...
		var startClass = _p19._0;
		var configClass = _p19._1;
		var updateClass = _p19._2;
		var cleanupClass = _p19._3;
		var finishedClass = _p19._4;
