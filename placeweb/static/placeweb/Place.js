...
var _PALab$place$Metadata$encode = function (metadata) {
...
var _PALab$place$Metadata$default = {
	title: 'no title',
	authors: {
		ctor: '::',
		_0: 'no authers',
...
var _PALab$place$Metadata$Metadata = F8(
	function (a, b, c, d, e, f, g, h) {
		return {title: a, authors: b, maintainer: c, email: d, url: e, elm: f, python: g, defaultPriority: h};
	});
var _PALab$place$Metadata$decode = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: _elm_lang$core$Json_Decode$null(_PALab$place$Metadata$default),
		_1: {
			ctor: '::',
			_0: A9(
			...
			_1: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'metadata',
						_1: _PALab$place$Metadata$encode(plugin.metadata)
					},
					_1: {
						ctor: '::',
...
var _PALab$place$Plugin$Plugin = F5(
	function (a, b, c, d, e) {
...
var _PALab$place$Plugin$decode = A6(
	...
	A2(_elm_lang$core$Json_Decode$field, 'metadata', _PALab$place$Metadata$decode),
			...
			_1: {
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'title',
						_1: _elm_lang$core$Json_Encode$string(experiment.title)
					},
					_1: {
						ctor: '::',
						_0: {
...
var _PALab$place$Experiment$Experiment = F5(
	function (a, b, c, d, e) {
		return {title: a, directory: b, updates: c, plugins: d, comments: e};
	});
var _PALab$place$Experiment$decode = A6(
	_elm_lang$core$Json_Decode$map5,
	_PALab$place$Experiment$Experiment,
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
	...
	A2(
		_elm_lang$core$Json_Decode$field,
		'plugins',
		_elm_lang$core$Json_Decode$dict(_PALab$place$Plugin$decode)),
...
var _PALab$place$ExperimentResult$Empty = function (a) {
	return {ctor: 'Empty', _0: a};
};
var _PALab$place$ExperimentResult$Aborted = function (a) {
	return {ctor: 'Aborted', _0: a};
};
var _PALab$place$ExperimentResult$Completed = function (a) {
	return {ctor: 'Completed', _0: a};
};
var _PALab$place$ExperimentResult$decode = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (result) {
		var _p0 = result;
		switch (_p0) {
			case 'completed':
				return A2(
					...
					function (progress) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$ExperimentResult$Completed(progress));
					},
			...
			case 'aborted':
				return A2(
					...
					function (experiment) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$ExperimentResult$Aborted(experiment));
					},
					A2(_elm_lang$core$Json_Decode$field, 'experiment', _PALab$place$Experiment$decode));
			default:
				return A2(
					...
					function (location) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$ExperimentResult$Empty(location));
					},
...
var _PALab$place$Place$stringToFilename = function (title) {
	...
	var valid = function (c) {
		return A2(
			_elm_lang$core$List$member,
			c,
			_elm_lang$core$String$toList('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_.- '));
	};
	var sub = function (c) {
		return space(c) ? _elm_lang$core$Maybe$Just(
			_elm_lang$core$Native_Utils.chr('_')) : (valid(c) ? _elm_lang$core$Maybe$Just(c) : _elm_lang$core$Maybe$Nothing);
	};
	var shortTitle = A2(_elm_lang$core$String$left, 25, title);
	var filename = _elm_lang$core$String$fromList(
		A2(
			_elm_lang$core$List$filterMap,
			sub,
			_elm_lang$core$String$toList(shortTitle)));
	var _p0 = filename;
	if (_p0 === '') {
		return 'data.zip';
	} else {
		return A2(_elm_lang$core$Basics_ops['++'], filename, '.zip');
	}
};
var _PALab$place$Place$statusCircle = function (status) {
	var title = _elm_lang$core$Native_Utils.eq(status, 'completed') ? 'Complete' : 'Incomplete/Aborted';
	var label = _elm_lang$core$Native_Utils.eq(status, 'completed') ? 'table__data--status-symbol-completed' : 'table__data--status-symbol-aborted';
	return A2(
...
var _PALab$place$Place$dateDecode = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (dateString) {
		var _p1 = _elm_lang$core$Date$fromString(dateString);
		if (_p1.ctor === 'Ok') {
	...
	_elm_lang$core$Json_Decode$string);
var _PALab$place$Place$posixEpochDecode = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (_p2) {
		return function (_p3) {
			return _elm_lang$core$Json_Decode$succeed(
...
var _PALab$place$Place$intDefault = F2(
...
var _PALab$place$Place$emptyPlugins = {ctor: '[]'};
var _PALab$place$Place$locationEncode = function (location) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
...
var _PALab$place$Place$hidePlugins = _elm_lang$core$Native_Platform.outgoingPort(
	'hidePlugins',
	function (v) {
		return null;
	});
...
var _PALab$place$Place$commandFromJavaScript = _elm_lang$core$Native_Platform.incomingPort('commandFromJavaScript', _elm_lang$core$Json_Decode$string);
var _PALab$place$Place$userChangedPlaceCfg = _elm_lang$core$Native_Platform.outgoingPort(
	'userChangedPlaceCfg',
	function (v) {
		return v;
	});
...
var _PALab$place$Place$parseVersion = function (versionStr) {
	var _p5 = A2(_elm_lang$core$String$split, '.', versionStr);
	if ((((_p5.ctor === '::') && (_p5._1.ctor === '::')) && (_p5._1._1.ctor === '::')) && (_p5._1._1._1.ctor === '[]')) {
		var _p6 = A4(
			_elm_lang$core$Result$map3,
			_PALab$place$Place$Version,
			_elm_lang$core$String$toInt(_p5._0),
			_elm_lang$core$String$toInt(_p5._1._0),
			_elm_lang$core$String$toInt(_p5._1._1._0));
		if (_p6.ctor === 'Ok') {
			return _p6._0;
		} else {
			return A3(_PALab$place$Place$Version, 0, 0, 0);
		}
	} else {
		return A3(_PALab$place$Place$Version, 0, 0, 0);
	}
...
var _PALab$place$Place$ExperimentEntry = F6(
	function (a, b, c, d, e, f) {
		return {status: a, date: b, title: c, comments: d, location: e, filename: f};
	});
var _PALab$place$Place$experimentEntryDecode = A7(
	...
	A2(
		...
		_elm_lang$core$Json_Decode$oneOf(
			{
				ctor: '::',
				_0: _PALab$place$Place$posixEpochDecode,
				_1: {
					ctor: '::',
					_0: _PALab$place$Place$dateDecode,
					_1: {ctor: '[]'}
				}
			})),
	A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string),
...
var _PALab$place$Place$ConfigurePlace = {ctor: 'ConfigurePlace'};
var _PALab$place$Place$History = function (a) {
	return {ctor: 'History', _0: a};
};
var _PALab$place$Place$Results = F2(
	function (a, b) {
		return {ctor: 'Results', _0: a, _1: b};
	});
...
var _PALab$place$Place$Running = function (a) {
	return {ctor: 'Running', _0: a};
};
var _PALab$place$Place$Ready = function (a) {
	return {ctor: 'Ready', _0: a};
};
var _PALab$place$Place$serverStatusDecode = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (status) {
		var _p7 = status;
		switch (_p7) {
			case 'Ready':
				return A2(
					...
					function (_p8) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$Place$Ready(_p8));
					},
					A2(_elm_lang$core$Json_Decode$field, 'history', _PALab$place$Place$experimentEntriesDecode));
			case 'Running':
				return A2(
					_elm_lang$core$Json_Decode$andThen,
					function (_p9) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$Place$Running(_p9));
					},
					A2(_elm_lang$core$Json_Decode$field, 'progress', _PALab$place$Progress$decode));
			case 'Error':
				return A2(
					...
					function (_p10) {
						return _elm_lang$core$Json_Decode$succeed(
							_PALab$place$Place$ServerError(_p10));
					},
					A2(_elm_lang$core$Json_Decode$field, 'error_string', _elm_lang$core$Json_Decode$string));
			case 'Unknown':
				return _elm_lang$core$Json_Decode$succeed(_PALab$place$Place$Unknown);
			default:
...
var _PALab$place$Place$ExperimentResultsToRepeat = function (a) {
	return {ctor: 'ExperimentResultsToRepeat', _0: a};
};
var _PALab$place$Place$ExperimentResults = function (a) {
	return {ctor: 'ExperimentResults', _0: a};
};
...
var _PALab$place$Place$placeGraphic = F3(
	function (currentPhase, updates, animate) {
		...
		var startClass = _p11._0;
		var configClass = _p11._1;
		var updateClass = _p11._2;
		var cleanupClass = _p11._3;
		var finishedClass = _p11._4;
		var etaString = function () {
			...
			return (_elm_lang$core$Native_Utils.cmp(seconds, 3.154e7) > 0) ? A2(
				...
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$round(seconds / 3.154e7)),
				' y') : ((_elm_lang$core$Native_Utils.cmp(seconds, 86400) > 0) ? A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$round(seconds / 86400)),
				' d') : ((_elm_lang$core$Native_Utils.cmp(seconds, 5940) > 0) ? A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$round(seconds / 3600)),
				' h') : ((_elm_lang$core$Native_Utils.cmp(seconds, 99) > 0) ? A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$round(seconds / 60)),
				' m') : ((_elm_lang$core$Native_Utils.cmp(seconds, 1) > 0) ? A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Basics$toString(
					_elm_lang$core$Basics$round(seconds)),
				' s') : '0 s'))));
		}();
		var _p13 = (_elm_lang$core$Native_Utils.cmp(updates, 100) < 0) ? {ctor: '_Tuple2', _0: '40', _1: '73.5'} : ((_elm_lang$core$Native_Utils.cmp(updates, 1000) < 0) ? {ctor: '_Tuple2', _0: '30', _1: '69'} : {ctor: '_Tuple2', _0: '20', _1: '66'});
		var size = _p13._0;
		var height = _p13._1;
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$height('140'),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$viewBox('0 0 600 120'),
						_1: {
							ctor: '::',
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$class('place-progress__text'),
							_1: {
								ctor: '::',
						...
						_0: A2(
							_elm_lang$svg$Svg$rect,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$height('51.726257'),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$x('117.14876'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$y('33.917477'),
												_1: {
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$rx('3.7218471'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$ry('3.7218471'),
														_1: {ctor: '[]'}
													}
												}
											}
							...
							_0: A2(
								_elm_lang$svg$Svg$text_,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$x('165'),
											_1: {
												ctor: '::',
												_0: _elm_lang$svg$Svg_Attributes$y('65'),
												_1: {ctor: '[]'}
								...
								{
									ctor: '::',
									_0: _elm_lang$svg$Svg$text('Configuration'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$transform('translate(294, 60)'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$svg$Svg_Attributes$style('fill:#fbfbfb;stroke:#333333;stroke-width:0.47117239'),
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$d(
															A2(
																														...
																														A2(
																															...
																															A2(
																																...
																																A2(
																																	_elm_lang$core$Basics_ops['++'],
																																	'12.6367199,7.773978 ',
																																	A2(_elm_lang$core$Basics_ops['++'], '12.7111819,9.350194 ', 'z')))))))))))))))))))),
														_1: {ctor: '[]'}
													}
												},
												function () {
															...
															_0: A2(
																_elm_lang$svg$Svg$animateTransform,
																{
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$svg$Svg_Attributes$from('360 0 0'),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$svg$Svg_Attributes$to('0 0 0'),
																				_1: {
																					ctor: '::',
											...
											_1: {
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$transform('rotate(180 0 0)'),
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$style('fill:#fbfbfb;stroke:#333333;stroke-width:0.47117239'),
															_1: {
																...
																_0: A2(
																	_elm_lang$svg$Svg$animateTransform,
																	{
																		...
																		_1: {
																			...
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$svg$Svg_Attributes$from('180 0 0'),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$svg$Svg_Attributes$to('-180 0 0'),
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$svg$Svg_Attributes$dur(
																							A2(
								...
								_1: {
										...
										_elm_lang$svg$Svg$rect,
										{
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$svg$Svg_Attributes$x('377.39545'),
														_1: {
															ctor: '::',
															_0: _elm_lang$svg$Svg_Attributes$y('33.917477'),
															_1: {
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$svg$Svg$text('Cleanup'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
												...
												_0: A2(
													_elm_lang$svg$Svg$text_,
													{
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$svg$Svg_Attributes$x('540'),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$svg$Svg_Attributes$y('65'),
																	_1: {ctor: '[]'}
														...
														_elm_lang$svg$Svg$text_,
														{
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$svg$Svg_Attributes$x('295'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$svg$Svg_Attributes$y(height),
																			_1: {ctor: '[]'}
																		}
																	}
																}
...
var _PALab$place$Place$update = F2(
	function (msg, model) {
		...
		while (true) {
			var _p18 = msg;
			switch (_p18.ctor) {
				case 'ChangeExperimentTitle':
					var oldExperiment = model.experiment;
					return {
						ctor: '_Tuple2',
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								experiment: _elm_lang$core$Native_Utils.update(
									oldExperiment,
									{
										updates: A2(_elm_lang$core$Basics$max, 1, oldExperiment.updates + _p18._0)
									})
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				...
				case 'RemoveExperimentPlugin':
					var _p19 = A2(_elm_lang$core$Json_Decode$decodeValue, _elm_lang$core$Json_Decode$string, _p18._0);
					if (_p19.ctor === 'Ok') {
						var oldExperiment = model.experiment;
						var newExperiment = _elm_lang$core$Native_Utils.update(
							oldExperiment,
							{
								plugins: A2(
									_elm_lang$core$Dict$filter,
									F2(
										function (k, v) {
											return !_elm_lang$core$Native_Utils.eq(k, _p19._0);
										}),
									oldExperiment.plugins)
							});
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
						...
						var _v13 = _PALab$place$Place$PlaceError(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'RemoveExperimentPlugin Err: ',
				...
				case 'UpdateExperimentPlugins':
					...
					if (_p20.ctor === 'Ok') {
						...
						var newExperiment = _elm_lang$core$Native_Utils.update(
							oldExperiment,
							{
								plugins: A2(_elm_lang$core$Dict$union, _p20._0, oldExperiment.plugins)
							});
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
						...
						var _v16 = _PALab$place$Place$PlaceError(
							A2(
								_elm_lang$core$Basics_ops['++'],
				...
				case 'GetResults':
					var body = _elm_lang$http$Http$jsonBody(
						_PALab$place$Place$locationEncode(_p18._0));
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(
							_elm_lang$http$Http$send,
							_PALab$place$Place$ExperimentResults,
							A3(_elm_lang$http$Http$post, 'results/', body, _PALab$place$ExperimentResult$decode))
					};
				case 'GetResultsToRepeat':
					var body = _elm_lang$http$Http$jsonBody(
						_PALab$place$Place$locationEncode(_p18._0));
					return {
						ctor: '_Tuple2',
						...
						_1: A2(
							_elm_lang$http$Http$send,
							_PALab$place$Place$ExperimentResultsToRepeat,
							A3(_elm_lang$http$Http$post, 'results/', body, _PALab$place$ExperimentResult$decode))
					};
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										state: _PALab$place$Place$History(
											_elm_lang$core$Maybe$Just(_p18._0))
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						case 'Results':
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										state: A2(_PALab$place$Place$Results, true, _p21._1)
									}),
								_1: _elm_lang$core$Platform_Cmd$none
							};
						default:
				...
				case 'ConfigureNewExperiment':
					...
					var newExperiment = A2(_elm_lang$core$Maybe$withDefault, defaultExperiment, _p18._0);
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							newModel,
							{state: _PALab$place$Place$ConfigureExperiment}),
						_1: _elm_lang$core$Platform_Cmd$batch(
							{
								ctor: '::',
								_0: _PALab$place$Place$pluginProgress(
									_PALab$place$Experiment$encode(newModel.experiment)),
								_1: {
									ctor: '::',
							...
							case 'Running':
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											state: _PALab$place$Place$LiveProgress(_p24),
											experiment: _p24.experiment
										}),
									_1: _elm_lang$core$Platform_Cmd$batch(
										{
											ctor: '::',
											_0: _PALab$place$Place$pluginProgress(
												_PALab$place$Experiment$encode(_p24.experiment)),
											_1: {
												ctor: '::',
												_0: A2(
													_elm_lang$core$Task$perform,
							...
							case 'ServerError':
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											state: _PALab$place$Place$Error(_p23._0)
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
							default:
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											state: _PALab$place$Place$Error('server returned status: Unknown')
										}),
									_1: _elm_lang$core$Platform_Cmd$none
								};
						}
							...
							case 'Completed':
								...
								return {
									...
									_0: _elm_lang$core$Native_Utils.update(
										model,
										{
											state: A2(_PALab$place$Place$Results, false, _p28),
											experiment: _p27.experiment
										}),
									_1: _elm_lang$core$Platform_Cmd$batch(
										{
											ctor: '::',
											...
											_1: {
												ctor: '::',
												_0: _PALab$place$Place$pluginProgress(
													_PALab$place$Experiment$encode(_p27.experiment)),
												_1: {ctor: '[]'}
											}
										})
								};
				...
				case 'ExperimentResultsToRepeat':
					var _p29 = _p18._0;
					if (_p29.ctor === 'Ok') {
						var _p30 = _p29._0;
						switch (_p30.ctor) {
							case 'Completed':
								var _v25 = _PALab$place$Place$ConfigureNewExperiment(
									_elm_lang$core$Maybe$Just(_p30._0.experiment)),
									_v26 = model;
								msg = _v25;
								model = _v26;
								continue update;
							case 'Aborted':
								var _v27 = _PALab$place$Place$ConfigureNewExperiment(
								...
								_1: _elm_lang$core$Platform_Cmd$batch(
									{
										...
										_1: {
											ctor: '::',
											_0: _PALab$place$Place$userChangedPlaceCfg(false),
											_1: {
												ctor: '::',
				...
				case 'UpdatePlaceConfiguration':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{placeConfiguration: _p18._0, placeCfgChanged: true}),
...
var _PALab$place$Place$start = function (flags) {
	var model = {
		state: _PALab$place$Place$Status,
		experiment: {title: '', directory: '', updates: 1, plugins: _elm_lang$core$Dict$empty, comments: ''},
		history: {ctor: '[]'},
...
var _PALab$place$Place$experimentFromUserConfig = function (config) {
	...
	if (_p33.ctor === 'Ok') {
		return _PALab$place$Place$ConfigureNewExperiment(
			_elm_lang$core$Maybe$Just(_p33._0));
	} else {
		return _PALab$place$Place$ConfigureNewExperiment(_elm_lang$core$Maybe$Nothing);
	}
};
var _PALab$place$Place$GetResultsToRepeat = function (a) {
	return {ctor: 'GetResultsToRepeat', _0: a};
};
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('table__data--status'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _PALab$place$Place$statusCircle(entry.status),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
											...
											_0: _elm_lang$core$Native_Utils.eq(
												...
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_PALab$place$Place$GetResultsToRepeat(entry.location)),
														_1: {ctor: '[]'}
													}
												},
												{
...
var _PALab$place$Place$RemoveExperimentPlugin = function (a) {
	return {ctor: 'RemoveExperimentPlugin', _0: a};
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_0: _PALab$place$Place$pluginConfig(
				function (value) {
					return _PALab$place$Place$UpdateExperimentPlugins(value);
				}),
			_1: {
				ctor: '::',
				_0: _PALab$place$Place$pluginRemove(
					function (value) {
						return _PALab$place$Place$RemoveExperimentPlugin(value);
					}),
				_1: {
					ctor: '::',
					_0: _PALab$place$Place$receiveConfigFile(
						function (value) {
							return _PALab$place$Place$experimentFromUserConfig(value);
						}),
					_1: {
						ctor: '::',
						_0: _PALab$place$Place$commandFromJavaScript(
							function (value) {
								return _PALab$place$Place$CommandFromJavaScript(value);
							}),
						_1: {ctor: '[]'}
					}
				}
...
var _PALab$place$Place$ChangeExperimentComments = function (a) {
	return {ctor: 'ChangeExperimentComments', _0: a};
};
var _PALab$place$Place$ChangeExperimentUpdates = function (a) {
	return {ctor: 'ChangeExperimentUpdates', _0: a};
};
var _PALab$place$Place$ChangeExperimentTitle = function (a) {
	...
	switch (_p34.ctor) {
		case 'Status':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('statusView'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Checking status of server...'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
		...
		case 'ConfigureExperiment':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('configure-experiment'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('configure-experiment__upload-area'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A3(_PALab$place$Place$placeGraphic, 'start', _p34._0, 0.0),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
			...
			var phaseText = function () {
				...
				switch (_p35) {
					...
					case 'update':
						return 'updating';
					case 'cleanup':
						return 'cleaning up after';
					default:
						return 'working on';
				}
			}();
			var updatesRemaining = _p36.totalUpdates - _p36.currentUpdate;
			return A2(
				_elm_lang$html$Html$div,
				{ctor: '[]'},
				{
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A3(_PALab$place$Place$placeGraphic, _p36.currentPhase, updatesRemaining, _p36.updateTime),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p36.experiment.title),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text(_p36.experiment.comments),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}),
												...
												_0: _elm_lang$html$Html$text(
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															phaseText,
															A2(_elm_lang$core$Basics_ops['++'], ' ', _p36.currentPlugin)))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
		...
		case 'Results':
			...
			switch (_p37.ctor) {
				case 'Completed':
					var _p38 = _p37._0;
					var location = A3(_elm_lang$core$String$slice, -7, -1, _p38.directory);
					return A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						{
												...
												_1: {
													...
													_0: _elm_lang$html$Html_Events$onClick(
														_PALab$place$Place$ConfigureNewExperiment(
															_elm_lang$core$Maybe$Just(_p38.experiment))),
													_1: {ctor: '[]'}
												}
											},
											{
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(_p38.experiment.title),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
														_0: A2(
															...
															{ctor: '[]'},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(_p38.experiment.comments),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	...
																	_1: {
																		...
																		_0: _elm_lang$html$Html$text(
																			A2(
																				...
																				A2(
																					_elm_lang$core$Basics_ops['++'],
																					_elm_lang$core$Basics$toString(_p38.experiment.updates),
																					_elm_lang$core$Native_Utils.eq(_p38.experiment.updates, 1) ? ' update)' : ' updates)'))),
																		_1: {ctor: '[]'}
																	}
																}
															}),
				...
				case 'Aborted':
					...
					var location = A3(
						...
						-7,
						-1,
						A2(_elm_lang$core$Basics_ops['++'], _p39.directory, ' '));
					return A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						{
														...
														_1: {
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text(_p39.title),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		...
																		{ctor: '[]'},
																		{
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text(_p39.comments),
																					_1: {ctor: '[]'}
																				}),
																			_1: {
																				ctor: '::',
																				...
																				_1: {
																					...
																					_0: _elm_lang$html$Html$text(
																						A2(
																							...
																							A2(
																								_elm_lang$core$Basics_ops['++'],
																								_elm_lang$core$Basics$toString(_p39.updates),
																								_elm_lang$core$Native_Utils.eq(_p39.updates, 1) ? ' update)' : ' updates)'))),
																					_1: {ctor: '[]'}
																				}
																			}
																		}),
								...
								_0: _p41 ? A2(
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_PALab$place$Place$DeleteExperiment(_p40)),
											_1: {ctor: '[]'}
										}
									},
									{
									...
									_elm_lang$html$Html$button,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_PALab$place$Place$ConfirmDeleteExperiment(_p40)),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('No valid data'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('No valid PLACE data could be found for this '),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html$text('experiment. It is possible that this is due '),
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('to some undiscovered PLACE error.'),
																	_1: {ctor: '[]'}
																}
															}
														}),
								...
								{ctor: '[]'},
								{
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('table__heading--status'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											A2(
												_elm_lang$core$List$map,
												_PALab$place$Place$historyRow(_p34._0),
												model.history)),
										_1: {ctor: '[]'}
									}
								}),
		...
		case 'ConfigurePlace':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('placeConfigurationView'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('place-configuration__title'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('PLACE Configuration'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('place-configuration_buttons'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('place-configuration__show-exp-history-button'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_PALab$place$Place$RefreshProgress),
											_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('place-configuration__show-experiment-config'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_PALab$place$Place$ConfigureNewExperiment(
									...
									_1: {
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Events$onClick(
																_PALab$place$Place$CommandFromJavaScript('configuration')),
															_1: {ctor: '[]'}
														}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Revert'),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
		...
		default:
			...
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('errorView'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Recheck server'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _PALab$place$Place$main = _elm_lang$html$Html$programWithFlags(
	{init: _PALab$place$Place$start, view: _PALab$place$Place$view, update: _PALab$place$Place$update, subscriptions: _PALab$place$Place$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (version) {
			return _elm_lang$core$Json_Decode$succeed(
