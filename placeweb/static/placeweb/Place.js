...
var _PALab$place$Status$PluginProgress = F2(
	function (a, b) {
...
var _PALab$place$Status$Point = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _PALab$place$Status$pointsDecode = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (xlist) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			function (ylist) {
				return _elm_lang$core$Json_Decode$succeed(
					A3(_elm_lang$core$List$map2, _PALab$place$Status$Point, xlist, ylist));
			},
			A2(
				_elm_lang$core$Json_Decode$field,
				'ydata',
	...
	A2(
		...
		'xdata',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$float)));
var _PALab$place$Status$seriesDecode = A3(
...
var _PALab$place$Status$pluginProgressDecode = A3(
	_elm_lang$core$Json_Decode$map2,
	_PALab$place$Status$PluginProgress,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(
		_elm_lang$core$Json_Decode$field,
		'plots',
...
var _PALab$place$Experiment$intDefault = F2(
			...
			_1: {
				...
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$int(
						A2(_PALab$place$Experiment$intDefault, '1', model.updates))
				},
				_1: {
					ctor: '::',
					_0: {
...
var _PALab$place$Experiment$experimentShowData = function (model) {
	var updates = A2(_PALab$place$Experiment$intDefault, '1', model.updates);
	var makeHeading = F2(
		function (num, name) {
			return A2(
...
var _PALab$place$Experiment$pluginProgress = _elm_lang$core$Native_Platform.outgoingPort(
	'pluginProgress',
	function (v) {
		return [v._0, v._1];
	});
			...
			F2(
				function (index, series) {
					var _p6 = A2(
						...
						colors);
					if (_p6.ctor === 'Just') {
						return A4(_terezka$line_charts$LineChart$line, _p6._0, _terezka$line_charts$LineChart_Dots$none, series.name, series.points);
					} else {
	...
	function (msg, model) {
		...
		switch (_p11.ctor) {
				...
				if (_p12.ctor === 'Ok') {
					...
					var newPlugins = function () {
						...
						if (_p13.ctor === 'Nothing') {
							...
							return A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Native_Utils.eq(_p15.className, 'None') ? _PALab$place$Experiment$emptyPlugins : _p16,
								A2(
									_elm_lang$core$List$filter,
									function (_p14) {
										return A2(
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								status: _PALab$place$Status$Error(_p12._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			case 'GetStatusResponse':
				if (_p11._0.ctor === 'Ok') {
					if (_p11._0._0.ctor === 'Running') {
						var _p17 = _p11._0._0._0;
						var updatePlugins = _elm_lang$core$Dict$values(
							A2(
								_elm_lang$core$Dict$map,
								F2(
									function (a, b) {
										return _PALab$place$Experiment$pluginProgress(
											{ctor: '_Tuple2', _0: a, _1: b});
									}),
								_p17.pluginProgress));
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									status: _PALab$place$Status$Running(_p17)
								}),
							A2(
								_elm_lang$core$Basics_ops['++'],
								updatePlugins,
						...
						case 'Running':
							...
							return A2(
								...
								},
								{
									...
									_0: _elm_lang$html$Html$text(
										_elm_lang$core$Basics$toString(
											_elm_lang$core$Basics$toFloat(_p19.currentUpdate) / _elm_lang$core$Basics$toFloat(_p19.totalUpdates))),
									_1: {ctor: '[]'}
								});
						default:
							return A2(
...
var _PALab$place$Place$update = F2(
	function (msg, model) {
		var _p0 = msg;
		var _p1 = A2(_PALab$place$Experiment$update, _p0._0, model.experiment);
...
var _PALab$place$Place$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (flags) {
			return A2(
				...
				_PALab$place$Place$ExperimentMsg(_PALab$place$Experiment$GetStatus),
				A3(
